...
public class ShopGoodsServiceImpl implements ShopGoodsService {
    ...
    public PageResult getNewBeeMallGoodsPage(PageQueryUtil pageUtil) {
        List<ShopGoods> goodsList = goodsMapper.findNewBeeMallGoodsList(pageUtil);
    ...
    @Override
    public String saveNewBeeMallGoods(ShopGoods goods) {
    ...
    public String updateNewBeeMallGoods(ShopGoods goods) {
        ShopGoods temp = goodsMapper.selectByPrimaryKey(goods.getGoodsId());
        if (temp == null) {
