...
public class ShopGoodsController {
    ...
    public String edit(HttpServletRequest request, @PathVariable("goodsId") Long goodsId) {
        ...
        if (newBeeMallGoods.getGoodsCategoryId() > 0) {
            if (newBeeMallGoods.getGoodsCategoryId() != null || newBeeMallGoods.getGoodsCategoryId() > 0) {
                ...
                GoodsCategory currentGoodsCategory = shopCategoryService.getGoodsCategoryById(newBeeMallGoods.getGoodsCategoryId());
                ...
                if (currentGoodsCategory != null && currentGoodsCategory.getCategoryLevel() == ShopCategoryLevelEnum.LEVEL_THREE.getLevel()) {
                    ...
                    //查询当前三级分类的父级二级分类
                    GoodsCategory secondCategory = shopCategoryService.getGoodsCategoryById(currentGoodsCategory.getParentId());
                    if (secondCategory != null) {
                        ...
                        //查询当前二级分类的父级一级分类
                        GoodsCategory firestCategory = shopCategoryService.getGoodsCategoryById(secondCategory.getParentId());
    ...
    @ResponseBody
    public Result update(@RequestBody ShopGoods newBeeMallGoods) {
