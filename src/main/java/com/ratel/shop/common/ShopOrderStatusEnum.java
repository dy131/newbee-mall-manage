...
public enum ShopOrderStatusEnum {
    ...
    ShopOrderStatusEnum(int orderStatus, String name) {
        this.orderStatus = orderStatus;
        this.name = name;
    }

    public static ShopOrderStatusEnum getNewBeeMallOrderStatusEnumByStatus(int orderStatus) {
        for (ShopOrderStatusEnum newBeeMallOrderStatusEnum : ShopOrderStatusEnum.values()) {
